...
| 2026-09-14 | No atmosphere glow on Android | Dropped from 7.2. iOS's shell is a 1.08-radius sphere at 0.15 alpha and 0.3 transparency — about 5% opaque — and would be the globe's only blended full-screen draw. iOS keeps it. |
